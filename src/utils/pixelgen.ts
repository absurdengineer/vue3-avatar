...
/** Deterministic, horizontally mirrored 8x8 grid derived from a string. */
export function generatePixelGrid(str: string | null | undefined): boolean[][] {
  if (!str)
    return Array(8)
      .fill(null)
...
/** Built-in palettes for pixel-art avatars. */
...
/** Renders a grid as a standalone SVG string. */
